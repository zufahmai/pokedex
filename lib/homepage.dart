...
//      pokeList.sort((a, b) {
//          var headerA = new StringBuffer();
//          for (var t in a.type) {
//            headerA.write(t.toString());
//            headerA.write(" ");
//          }
//          var headerB = new StringBuffer();
//          for (var t in b.type) {
//            headerB.write(t.toString());
//            headerB.write(" ");
//          }
//          return headerA.toString().compareTo(headerB.toString());
//      });
//      for(Pokemon p in pokeList) {
//          header = new StringBuffer();
//          for (var t in p.type) {
//              header.write(t.toString());
//              header.write(" ");
//          }
//          if(!listHeader.contains(header.toString())) {
//             listHeader.add(header.toString());
//          }
//          pokeData.add(p);
//      }
//      return new ListView.builder(itemCount: pokeList.toSet().toList().length, itemBuilder: (context, index){
